...
function createMockProcessor(eolChar, skipFieldsStartingWith) {
    ...
    return (mockRows) => {
        ...
        if (firstEmptyRow > 0) {
            ...
            mockRows = mockRows.slice(0, 1);
            // hmmm?
            // maybe just skip the file if it is completely empty, or add a param
            // to stringify columns only
            // columnsToSave.join('\t')
        }
